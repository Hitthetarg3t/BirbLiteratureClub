...
main.Add("Radio", "x130 yp Checked" (config["mutation"]["mutation"] = "Movespeed"), "Movespeed").OnEvent("Click", (control, *) => updateValue("mutation", "mutation", control.Text))
main.Add("Radio", "x370 yp Checked" (config["mutation"]["mutation"] = "Convert"), "Convert").OnEvent("Click", (control, *) => updateValue("mutation", "mutation", control.Text))
...
main.Add("Radio", "xp+66 yp Checked" (config["mutation"]["mutation"] = "Attack"), "Attack").OnEvent("Click", (control, *) => updateValue("mutation", "mutation", control.Text))
main.Add("Radio", "x30 y200 Checked" (config["mutation"]["mutation"] = "Critical Chance"), "Critical Chance").OnEvent("Click", (control, *) => updateValue("mutation", "mutation", control.Text))
main.Add("Radio", "x436 yp Checked" (config["mutation"]["mutation"] = "Instant Conversion"), "Instant Conversion").OnEvent("Click", (control, *) => updateValue("mutation", "mutation", control.Text))
tabs.UseTab("Boost")
main.SetFont("s11")
